package com.julian001.arcadia.packages;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import net.minecraft.entity.player.EntityPlayer;

import com.julian001.arcadia.AbstractPacket;
...
public class OpenGuiPacket extends AbstractPacket {
	...
	public void handleServerSide(EntityPlayer player) {
		...
		player.openGui(arcadia.instance, id, player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
	}
}