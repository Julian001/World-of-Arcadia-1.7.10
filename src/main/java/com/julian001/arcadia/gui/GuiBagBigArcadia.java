...
public class GuiBagBigArcadia extends GuiContainer
{
	...
	*/
	public ResourceLocation iconLocation = new ResourceLocation("arcadia", "textures/gui/bagHuge.png");
	
	
	/** The inventory to render on screen */
	private final InventoryBagBigArcadia inventory;
	
	public GuiBagBigArcadia(ContainerBagBigArcadia container)
	{
	         super(container);
	...
	*/
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
	         ...
	         this.fontRendererObj.drawString("Big Bag", this.xSize / 2 - 102, -20, 4210752);
	         //this.fontRenderer.drawString("Huge Bag", 8, -30, 4210752); 0x4C3C17
	         this.fontRendererObj.drawString(I18n.format("container.inventory", new Object[0]), 8, 102, 4210752);
	}
