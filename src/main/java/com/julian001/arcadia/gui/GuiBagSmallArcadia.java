...
public class GuiBagSmallArcadia extends GuiContainer
{
	...
	*/
	public ResourceLocation iconLocation = new ResourceLocation("arcadia", "textures/gui/bagSmall.png");
	
	
	/** The inventory to render on screen */
	private final InventoryBagSmallArcadia inventory;
	
	public GuiBagSmallArcadia(ContainerBagSmallArcadia container)
	{
	         super(container);
	...
	*/
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
	         ...
	         this.fontRendererObj.drawString("Small Bag", this.xSize / 2 - 102, -1, 4210752);
	         //this.fontRenderer.drawString("Huge Bag", 8, -30, 4210752); 0x4C3C17
	         this.fontRendererObj.drawString(I18n.format("container.inventory", new Object[0]), 8, 66, 4210752);
	}
