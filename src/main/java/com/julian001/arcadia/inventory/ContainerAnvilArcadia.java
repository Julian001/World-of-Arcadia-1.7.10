...
public class ContainerAnvilArcadia extends Container {
	...
	public ContainerAnvilArcadia(InventoryPlayer inventoryplayer, World world,
			int i, int j, int k) {
...
//                        if (itemstack != null) {
//                                entityplayer.dropItem(itemstack, 1);ContainerWorkbench
//                        }
//                }
// 
//    }
	...
	public boolean canInteractWith(EntityPlayer entityplayer) {
		if (worldObj.getBlock(posX, posY, posZ) != BlocksArcadia.anvilArcadia) {
			return false;
		} else {
