...
public class ContainerBagBigArcadia extends Container
{
	/** The Item Inventory for this Container */
	public final InventoryBagBigArcadia inventory;
	...
	* InventoryItem.INV_SIZE and if we ever change it, the Container updates automatically. */
	private static final int INV_START = InventoryBagBigArcadia.INV_SIZE, INV_END = INV_START+26,
...
public ContainerBagBigArcadia(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryBagBigArcadia inventoryItem)
{
	...
	for (i = 0; i < InventoryBagBigArcadia.INV_SIZE; ++i)
	{
	...
	this.addSlotToContainer(new SlotBagArcadia(this.inventory, i, 8 + (18 * (int)(i/6)), -8 + (18*(i%6))));
	}
	...
	*/
	...
	((InventoryBagBigArcadia) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
