...
public class ContainerBagMediumArcadia extends Container
{
	/** The Item Inventory for this Container */
	public final InventoryBagMediumArcadia inventory;
...
public ContainerBagMediumArcadia(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryBagMediumArcadia inventoryItem)
{
	...
	for (i = 0; i < InventoryBagMediumArcadia.INV_SIZE; ++i)
	{
	...
	this.addSlotToContainer(new SlotBagArcadia(this.inventory, i, 8 + (18 * (int)(i/3)), 12 + (18*(i%3))));
	}
	...
	*/
	...
	((InventoryBagMediumArcadia) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
