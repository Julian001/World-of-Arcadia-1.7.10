...
public class ItemBlockSlabArcadia2 extends ItemBlock {

	private final boolean field_150948_b;
    private final BlockSlab field_150949_c;
    private final BlockSlab field_150947_d;

    public ItemBlockSlabArcadia2(Block p_i45355_1_, BlockSlabArcadia2 p_i45355_2_, BlockSlabArcadia2 p_i45355_3_, Boolean p_i45355_4_)
    {
        super(p_i45355_1_);
