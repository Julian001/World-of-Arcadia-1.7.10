...
public class CraftingManagerAnvilArcadia
{
	...
	recipes = new ArrayList();
		...
		this.addRecipe(new ItemStack(ItemsArcadia.chestplateRuby, 1), new Object[] {
			"#   #",
			"## ##",
			"#####",
			"#####",
			"#####", '#', ItemsArcadia.arcadiaItem});
		
		this.addRecipe(new ItemStack(ItemsArcadia.chestplateSapphire, 1), new Object[] {
			"#", '#', ItemsArcadia.bagArcadia		});
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public ShapedRecipesAnvilArcadia addRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
	{
		String s = "";
        int i = 0;
        int j = 0;
        ...
        ShapedRecipesAnvilArcadia shapedrecipes = new ShapedRecipesAnvilArcadia(j, k, aitemstack, par1ItemStack);
	...
	public void addShapelessRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
	{
        ...
        this.recipes.add(new ShapelessRecipesAnvilArcadia(par1ItemStack, arraylist));
	}
