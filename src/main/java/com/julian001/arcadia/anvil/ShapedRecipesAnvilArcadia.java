...
public class ShapedRecipesAnvilArcadia implements IRecipe {
	...
	public ShapedRecipesAnvilArcadia(int par1, int par2,
	...
	public ShapedRecipesAnvilArcadia func_92100_c() {
